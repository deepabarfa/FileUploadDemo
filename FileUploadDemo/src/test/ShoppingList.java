...
public class ShoppingList extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		ProductViewConnect cv=new ProductViewConnect();//it is an class where we write database connectivity code and here we create object ofthat class and use.
		
		ArrayList<Zeppy> list=cv.productview();//using ArrayList we get all the data which in the list object. here Zeppy is class where all the getter and setter function define. and productview() id function the is call by ProductViewConnect class object.
