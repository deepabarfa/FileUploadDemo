...
public class Registration extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int mobile1=Integer.parseInt(request.getParameter("mobile"));
	    ...
	    if(y==1)//if query successfully execute then
 		{//we want to send a massage after registration
	      ...
	      String from = "deepabarfa30595@gmail.com";
	      final String username = "deepabarfa30595@gmail.com";//change accordingly
	      //sended by mail with this user name or email id
	      final String password = "d&$@7694919777";//change accordingly
	    ...
	    if(y==1)//after successfully massage send then
		{
		...
		else
		{
			...
			request.setAttribute("msg", "Please Enter carefully");
			rd.forward(request, response);
		}
	    }
}
