...
/**
 * Servlet implementation class CustomerOrderStatusController
 */
@WebServlet("/CustomerOrderStatusController")
public class CustomerOrderStatusController extends HttpServlet {
     ...
     */
    public CustomerOrderStatusController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String id=(String)ss.getAttribute("user");//get user identity
		ArrayList<Zeppy> list=oc.CustomerViewStatus(id);//view database code
		  RequestDispatcher rd=request.getRequestDispatcher("CustomerShowOrderStatus.jsp");//its send the execution
