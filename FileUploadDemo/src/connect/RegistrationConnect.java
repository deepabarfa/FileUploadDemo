...
public int insert(String email,String name,String lastname,String city,String state,String pin,String address,int mobile,String password)//insert function
{
	 int x=0;
		try {
...
public int updateprofile(String email, String name, String city, String state, String pin, String mobile, String password, String address) 
{
	int x=0;
	try {	
		 Connection con=start();
	    PreparedStatement ps=con.prepareStatement("update registration set name=?,city=?,state=?,pin=?,mobile=?,password=?,address=? where email=?");
