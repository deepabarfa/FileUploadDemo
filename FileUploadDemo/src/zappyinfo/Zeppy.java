...
public class Zeppy 
{
	...
	public String toString() {
		return "Zeppy [uid=" + uid + ", email=" + email + ", name=" + name + ", lastname=" + lastname + ", city=" + city
	...
	public Zeppy(String uid,String email, String name, String lastname, String city, String state, String pin, String address,
			int mobile, Double tamount,String password,String date,int status, int productID, String productname, Double price, String weight, String details,
